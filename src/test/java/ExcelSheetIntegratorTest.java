...
public class ExcelSheetIntegratorTest {
    ...
    public void test() throws IOException {
        ...
        ExcelFile exFile1 = ExcelFile.fromFile(input1).withSheetName("name1");
        ExcelFile exFile2 = ExcelFile.fromFile(input2).withSheetName("name2");
        ExcelFile exFile3 = ExcelFile.fromFile(input3).withSheetName("name3");
